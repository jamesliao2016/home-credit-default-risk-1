...
def main():
    ...
    for fname in [
        ...
        './output/0827-2047.seed.2.param.1.csv.gz',  # 0.7940356368252524 +- 0.0019069793637920818
        './output/0827-2240.seed.2.param.2.csv.gz',  # 0.7958870709897761 +- 0.0018359147122171291
    ]:
        print(fname)
